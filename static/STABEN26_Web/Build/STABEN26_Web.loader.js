function createUnityInstance(t, n, l) {
  ...
  var f,
    ...
    _ = {
      ...
      ConnectToProfiler: function () {
        if (b.ConnectToProfiler) return b.ConnectToProfiler.apply(b, arguments);
        b.print("Failed to execute ConnectToProfiler: Player not loaded yet.");
      },
      StopProfiling: function () {
        if (b.StopProfiling) return b.StopProfiling.apply(b, arguments);
          ...
          n = {
                            ...
                            case 1:
                              ...
                              if (W) {
                                ...
                                for (
                                  ...
                                  T.lens[A++] = 5;
                                z(2, T.lens, 0, 32, H, 0, T.work, { bits: 5 }),
                                  (W = !1);
                              }
                              if (
                                ((T.lencode = M),
                    ...
                    Z(e, e.output, e.next_out, f - e.avail_out)
                      ...
                      : ((u -= e.avail_in),
                        ...
                        n.wrap &&
                          f &&
                          (e.adler = n.check =
                            (n.flags ? I : B)(n.check, o, f, e.next_out - f)),
                        (e.data_type =
                          n.bits +
                          (n.last ? 64 : 0) +
                          (12 === n.mode ? 128 : 0) +
            ...
            "zlib/inftrees.js": function (e, t, n) {
              ...
              t.exports = function (e, t, n, r, o, a, i, s) {
                ...
                for (_ = g, k = 15; 1 <= k && 0 === T[k]; k--);
                if ((k < _ && (_ = k), 0 === k))
                  (o[a++] = 20971520), (o[a++] = 20971520), (s.bits = 1);
                else {
                  for (y = 1; y < k && 0 === T[y]; y++);
                  for (_ < y && (_ = y), w = C = 1; w <= 15; w++)
                    if ((C = (C <<= 1) - T[w]) < 0) return -1;
                  if (0 < C && (0 === e || 1 !== k)) return -1;
                  for (D[1] = 0, w = 1; w < 15; w++) D[w + 1] = D[w] + T[w];
                  for (v = 0; v < r; v++)
                    0 !== t[n + v] && (i[D[t[n + v]]++] = v);
                  if (
                    ((h =
  ...
  function T() {
    var t = performance.now(),
      m =
        (Promise.all([
          A("frameworkUrl").then(function (e) {
