...
export const MARKDOWNS = [
  ...
  {
    name: "cafe_links",
    markdownSv: "[Jobbarschema](/committees/cafe/schedule)",
    markdownEn: "[Worker schedule](/committees/cafe/schedule)",
  },
  {
    name: "nollu_links",
    markdownSv: "[Phaddergrupper](/committees/nollu/groups)",
    markdownEn: "[Mentor groups](/committees/nollu/groups)",
  },
  ...[
    "hjalp",
    "privacy-policy",
