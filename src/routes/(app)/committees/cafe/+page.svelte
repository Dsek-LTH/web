...
<CommitteePage {data} bind:isEditing>
	<div
		slot="before"
		class="card border-primary bg-base-100 float-right ml-4 w-full border p-6 shadow-xl lg:max-w-80"
	>
		<h2 class="mb-2 p-2 font-bold lg:text-xl">
			{m.committees_cafe_openinghours()}
			<span class="text-base-content text-opacity-40 block text-sm font-light"
