			...
			{#if boardMember.studentId}
				<div class="group/photo card-body p-4 text-center">
					<a href="/members/{boardMember.studentId}" class="group/link">
						...
						<h2
							class="card-title text-primary mt-8 block text-pretty group-hover/link:underline"
						>
							{getFullName(boardMember)}
						</h2>
					</a>
					<div class="text-base-content/90 flex flex-col gap-1 px-2">
						<a
						...
						<a
							class="text-base-content/90 flex items-center justify-center gap-1 text-sm hover:underline"
			...
			{:else}
				...
				<div class="group/photo">
					...
					<div class="card-body px-0 text-center">
						<h2 class="card-title text-primary mx-auto">V.A. Kant</h2>
						<div class="text-base-content/90 flex flex-col gap-1 px-2">
							<a
								class="hover:underline"
								href="/positions/{boardMember.position.id}"
							...
							<a
								class="text-base-content/70 flex items-center justify-center gap-1 text-sm hover:underline"
								href="mailto:{boardMember.position.email}"
							>
								<span class="i-mdi-email"></span>
								{boardMember.position.email}
