...
<Modal show={member?.id === viewedMember?.id && showModal}>
  ...
  >
    ...
    <div class="mt-4 flex flex-wrap gap-2 *:flex-1">
      ...
      <button type="submit" class="btn" name="skipAction" value="skip">
        {m.members_phadder_group_modal_skip()}
      </button>
      <button type="submit" class="btn" name="skipAction" value="never">
