...
<div
	class="collapse-arrow rounded-btn border-base-200 collapse border-2 {revealTheme
		? 'bg-[#ECDDBC]'
...
>
	...
	<div class="collapse-title flex flex-col">
		...
		<span class="text-secondary text-sm font-medium capitalize"
		...
		{#if event.location}
			<span class="text-base-content text-sm font-medium">{event.location}</span
			>
		{/if}
	...
	<div class="collapse-content flex flex-col">
		{#if event.shortDescription}
			<MarkdownBody
				class="text-base-content text-xl font-medium"
