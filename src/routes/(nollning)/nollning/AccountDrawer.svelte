...
<div class="drawer-end">
	...
	<div class="drawer-side z-20">
		...
		<!-- Drawer content -->
		<aside
			class="rounded-box bg-base-100 flex min-h-full max-w-72 flex-col items-stretch rounded-r-none px-4 pb-6 md:max-w-80"
		...
		>
			...
			<LanguageSwitcher class=" border-base-300 bg-base-100 mt-8" />
		</aside>
	</div>
</div>
