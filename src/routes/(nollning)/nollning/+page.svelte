<script>
  ...
  const stab = [
    ...
    },
    {
      ...
      bodyEn:
        "Born from the deepest layers of the permafrost, Knyx Gelator stands as an unyielding wall, vigilantly watching over the boundaries of the realm. For him, the cold is a shield that protects and preserves. With a watchful eye over all paths, Knyx ensures that the ice supports and that no cracks appear in the structure of the Stab. He carries the key to security and ensures that the nollor move safely across the frozen landscape.",
    },
  ];
