...
<section id="kladkod">
	<ul
		class="[&_img]:rounded-box grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4 [&_h6]:font-semibold [&_i]:z-0 [&_i]:text-sm [&_i]:opacity-80 [&_img]:mb-2 [&_img]:object-contain [&_p]:mt-2 [&>li>h6]:text-lg"
	>
		<li>
		...
		<li>
			<img width={1512} height={2016} src={mixed} alt="Bruten kavaj exempel" />
		...
		<li>
			<img width={1512} height={2016} src={frack} alt="Högtidsdräktsexempel" />
