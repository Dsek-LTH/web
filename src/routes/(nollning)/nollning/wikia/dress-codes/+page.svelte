<script lang="ts">
  ...
  import slasque from "$lib/nollning/dressCode/slasque.webp";
  import mixed from "$lib/nollning/dressCode/mixed.webp";
  import suit from "$lib/nollning/dressCode/suit.webp";
  import frack from "$lib/nollning/dressCode/hogtids.jpg";
  import ouvve from "$lib/nollning/dressCode/ouvve.jpg";
  import bruten from "$lib/nollning/dressCode/brutenOuvve.jpg";
</script>
...
<div>
  <section id="kladkod">
    <ul
      class="grid grid-cols-1 gap-8 md:grid-cols-6 [&>li>h6]:text-lg [&_h6]:font-semibold [&_i]:z-0 [&_i]:text-sm [&_i]:opacity-80 [&_img]:mb-2 [&_img]:rounded-box [&_img]:object-contain [&_p]:mt-2"
    >
      <li class="md:col-span-3 md:col-start-2 xl:col-span-2 xl:col-start-2">
        <img width={1512} height={2016} src={slasque} alt="Slasque-exempel" />
        <h6>{@html m.nolla_packing_slasque()}</h6>
        <p>
          {@html m.nolla_packing_slasque_description()}
        </p>
      </li>
      <li class="md:col-span-3 xl:col-span-2 xl:col-start-4">
        <img
          width={1512}
          height={2016}
          src={bruten}
          alt="Bruten-ouvve-exempel"
        />
        <h6>{@html m.nolla_packing_broken()}</h6>
        <p>
          {@html m.nolla_packing_broken_description()}
        </p>
      </li>
      ...
      <li class="md:col-span-2">
        <img width={1512} height={2016} src={suit} alt="Mörk kostym exempel" />
