<script lang="ts">
  ...
  import cellar from "./cellar.webp";
  import floor1 from "./floor1.webp";
  import floor2 from "./floor2.webp";
...
<div class="flex flex-col md:flex-row">
  <img
    class="w-full max-w-sm {revealTheme ? '' : 'rounded-btn bg-black/20 p-4'}"
    alt="Map of campus"
    src={map}
  />
  <div
