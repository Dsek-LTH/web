...
<div
	class="nolla-pre-reveal drawer font-nolla-sans flex-1"
	data-theme="nollningPreReveal"
>
	<input id="my-drawer-3" type="checkbox" class="drawer-toggle" bind:checked />
	<div class="drawer-content flex flex-col">
		<!-- Navbar -->
		<nav class="navbar container mx-auto w-full p-6 lg:py-12">
			...
			<ul
				class="*:from-primary *:to-primary hidden w-full gap-24 text-2xl font-semibold *:bg-gradient-to-r *:bg-[length:0_2px] *:bg-bottom *:bg-no-repeat *:transition-all lg:flex"
			>
	...
	<nav class="drawer-side">
		...
		></label>
		<ul
			class="menu menu-lg bg-base-200 min-h-full w-80 p-4 text-2xl font-semibold"
		>
