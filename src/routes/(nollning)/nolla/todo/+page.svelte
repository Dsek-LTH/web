...
<article class="space-y-16 md:space-y-32">
	<section
		class="neo-brutal-border box-shadow-black-lg bg-secondary grid grid-cols-1 overflow-hidden md:grid-cols-2"
	>
		<img
	...
	<section
		class="neo-brutal-border box-shadow-black-lg bg-primary grid grid-cols-1 overflow-hidden md:grid-cols-2"
	>
