...
<header
	class="flex h-[calc(100vh-var(--navbar-size))] flex-col justify-between pb-12 md:py-24"
>
	<div class="flex flex-col items-center justify-between gap-2 md:flex-row">
		<h1
			class="font-nolla-mono text-left text-4xl leading-[1.1] sm:text-6xl lg:text-8xl"
		>
...
<article
	id="links"
	class="neo-brutal-box bg-secondary flex flex-col items-stretch justify-center gap-8 lg:h-72 lg:w-full lg:flex-row lg:items-center lg:gap-24"
>
