  ...
  <div class="layout-container w-full">
    <div class="flex-1">
      ...
      <div class="group dropdown dropdown-hover">
        ...
        <ul
          class="menu dropdown-content rounded-box !visible z-10 w-52 -translate-y-3 bg-base-100 p-2 text-base-content opacity-0 shadow-lg shadow-black/30 group-hover:translate-y-0"
        >
