...
<header
	class="navbar bg-base-300 bg-opacity-60 sticky top-0 z-10 justify-between gap-2 overflow-hidden filter backdrop-blur transition-all"
...
>
	...
	<div class="min-w-0 flex-1">
		<h1
			class="mx-auto overflow-hidden text-xl font-bold text-ellipsis whitespace-nowrap"
		>
			{$pageTitle}
		</h1>
	</div>
