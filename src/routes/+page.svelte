	...
	<div class="drawer-content">
		<nav class="z-10 px-10 lg:px-20 xl:px-32">
			...
			<div class="hidden items-center gap-4 lg:flex">
				...
				<button
					class="bg-[#433C3F]/60 px-8 py-4 text-white uppercase"
					on:click={signIn}
				>
					{m.navbar_logIn()}
				</button>
		...
		>
			<div class="absolute top-1/3 px-10 lg:pl-44">
				...
				<div class="flex flex-row items-start gap-10 lg:items-center">
					<a
						href="/nolla"
						class="bg-primary inline-block px-5 py-3 font-bold text-white lg:text-xl"
					>
		...
		>
			{#each LINKS as link}
				<li>
					<a
						href={link.href}
						class="active:!bg-primary/10 uppercase"
			...
			{/each}
			<li>
				<button class=" bg-[#433C3F]/60 text-white uppercase" on:click={signIn}>
					{m.navbar_logIn()}
				</button>
				<a
					class="my-2 bg-[#433C3F]/60 text-white uppercase"
					href="https://auth.dsek.se/if/flow/lu-signup/?next=%2F"
				>
					{m.navbar_register()}
				</a>
