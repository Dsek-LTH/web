...
<nav
	class="btm-nav bg-base-300 bg-opacity-60 right-2 left-2 w-[calc(100%-1rem)] overflow-hidden rounded-lg filter backdrop-blur"
	style="bottom: {bottomInsets || 16}px;"
>
	<div
		class="bg-primary absolute bottom-1 h-px w-[15%] transition-all ease-out"
