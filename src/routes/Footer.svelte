<footer class="footer bg-base-200 text-neutral-content mt-8 items-center p-2">
  ...
  <nav class="grid-flow-col place-self-center md:place-self-end">
    ...
    <a class="btn" href="https://facebook.com/Dsektionen">
      <span class="i-mdi-facebook h-6 w-6" />
    </a>
    <a class="btn" href="https://youtube.com/channel/UCqBtN7xlh4_VvywKaRiGfkw">
      <span class="i-mdi-youtube h-6 w-6" />
    </a>
