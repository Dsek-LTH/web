...
<div class="dropdown">
	...
	<ul
		tabindex={0}
		role="listbox"
		class="menu-compact menu dropdown-content join join-vertical bg-base-100 z-10 flex max-h-80 w-full flex-col flex-nowrap overflow-y-auto rounded-md shadow lg:max-w-[20rem]"
		id="tags-panel"
	>
		{#each filteredTags as tag (tag.id)}
			<li>
				<button
					type="button"
					class="join-item border-b-base-content/10 w-full border-b {selectedTags.includes(
						tag,
					)
