...
>
	<div class="relative flex h-full flex-col gap-2">
		{#if member}
			<div class="absolute top-1/2 left-4 flex -translate-y-1/2 justify-center">
		...
		/>
		<span
			class="loading loading-spinner loading-md text-primary absolute top-1/2 right-2 -translate-y-1/2 transition-opacity opacity-{isSearching
				? '100'
				: '0'}"
		></span>
	</div>
