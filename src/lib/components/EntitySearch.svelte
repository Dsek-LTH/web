...
<div class={twMerge("dropdown overflow-visible", clazz)}>
	<slot />
	<ul
		class="menu-compact menu dropdown-content join join-vertical bg-base-100 z-10 flex max-h-80 min-w-[20rem] flex-col flex-nowrap overflow-visible overflow-y-auto rounded-md p-0 shadow shadow-black"
	>
