...
<div class="relative">
	...
	>
				...
				{#each Object.entries(NotificationSettingType) as notificationSettingType}
					<li class="w-full space-y-2 first:pt-0 last:pb-0">
						...
						<label class="flex cursor-pointer flex-row justify-between">
							<span class="flex-1 text-sm font-medium text-wrap">
							...
							/>
							<div
								class="peer peer-checked:bg-primary relative h-6 w-11 rounded-full bg-gray-300 peer-focus:ring-4 peer-focus:ring-gray-400 peer-focus:outline-none after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white rtl:peer-checked:after:-translate-x-full dark:border-gray-600 dark:bg-gray-700 dark:peer-focus:ring-blue-800"
							></div>
						</label>
		...
		<button
			class="btn btn-primary bg-primary absolute bottom-0 mt-4 mb-4 w-full max-w-xl"
