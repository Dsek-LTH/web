...
<div
  class="hover:bg-muted-background animate-in fade-in fill-mode-backwards slide-in-from-bottom-[2rem] border-border flex w-full flex-col rounded-xl border-[1px] p-4 duration-300"
