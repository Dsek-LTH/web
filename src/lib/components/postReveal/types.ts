import { PUBLIC_PRE_STABSREVEAL_DATE } from "$env/static/public";

export const NOLLNING_TAG_PREFIX = "[NOLLNING]";
export const POST_REVEAL_PREFIX = "/nollning";

export const REVEAL_LAUNCH_DATE = new Date(PUBLIC_PRE_STABSREVEAL_DATE); // NEEDS TO BE UPDATED EVERY YEAR
